...
export const bootstrapIconMap = {
  ...
  'bi bi-filetype-pdf': { pack: 'bs', name: 'BsFileTypePdf' },
  'bi bi-filetype-doc': { pack: 'bs', name: 'BsFileTypeDoc' },
  'bi bi-filetype-xls': { pack: 'bs', name: 'BsFileTypeXls' },
  'bi bi-filetype-ppt': { pack: 'bs', name: 'BsFileTypePpt' },
...
export const emojiIconMap = {
  ...
  '🗜️': { pack: 'fi', name: 'FiCompress', label: 'Compress' },
  ...
  '🧠': { pack: 'fi', name: 'FiBrain', label: 'Brain' },
