...
def test_image_conversion():
    ...
    try:
        ...
        assert result and os.path.exists(test_output), "Direct image conversion failed"
        ...
        assert result2 and os.path.exists(test_output2), "Service image conversion failed"
        ...
        assert result3 and os.path.exists(test_output3), "Alternate service image conversion failed"
